...
> 이 테이블은 Phase 2 소스 선택과 Phase 5 압축 우선순위를 안내한다. 기반 분류(RAG / Memory / Tool Result)는 [context-source-strategy.md](skills/context-engineering/references/context-source-strategy.md) 참조.
...
| [`context-source-strategy.md`](skills/context-engineering/references/context-source-strategy.md) | 2 | RAG / Memory / Tool Result 전략 분류 |
